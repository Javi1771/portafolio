        ...
        title={
          <div className="space-y-6 relative">
            <div className="relative inline-block">
              <h1 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-gray-900 via-red-800 to-gray-900 dark:from-white dark:via-red-200 dark:to-white bg-clip-text text-transparent leading-tight">
                Mí experiencia
              </h1>
              ...
              {/* Animated underline */}
              <div className="absolute bottom-0 left-0 h-1 w-full origin-left scale-x-0 bg-gradient-to-r from-pink-600 via-rose-500 to-red-700 animate-scale-x"></div>
            </div>
