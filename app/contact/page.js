...
import { EMAIL, WHATSAPP, GITHUB_ACCOUNTS, LINKEDIN } from "@/data/links";
...
export default function ContactPage() {
  ...
  const createWhatsAppLink = (message) => {
    ...
    const formattedNumber = phoneNumber.startsWith("52")
      ? phoneNumber
      : `52${phoneNumber}`;
            ...
            <div className="space-y-6">
              ...
              <a
                href={createWhatsAppLink(
                  "Hola Javier, me interesa discutir un proyecto contigo."
                )}
                target="_blank"
                ...
                <div className="relative flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white/90 text-sm">
                      Respuesta inmediata • Disponible 9:00 - 18:00
                    </p>
                  </div>
              ...
              >
                ...
                <div className="absolute top-2 right-2 w-2 h-2 bg-blue-400/50 rounded-full animate-pulse"></div>
                ...
                >
                  ...
                  <div className="relative flex items-center gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      <svg
                        className="w-6 h-6 text-gray-600 dark:text-gray-400 group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                      >
